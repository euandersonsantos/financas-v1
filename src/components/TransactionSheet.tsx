...
export const TransactionSheet: React.FC<TransactionSheetProps> = ({
  ...
  return (
    <section className="absolute w-full flex flex-col items-center bg-white h-[654px] pt-6 pb-[122px] px-[21px] rounded-[24px_24px_0px_0px] left-0 bottom-[122px] max-sm:pt-5 max-sm:pb-[100px] max-sm:px-[15px]">
