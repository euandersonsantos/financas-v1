...
// Helper function to calculate daily balance
...
export const TransactionSheet: React.FC<TransactionSheetProps> = ({
  ...
  const groupedTransactions = isClosingTab ? (() => {
    ...
    // Sort dates: 20 de Jun 2025 should come before 25 de Jun 2025
        ...
        <div className="flex w-full flex-col items-end gap-6 max-w-[360px]">
          ...
          <div className="flex flex-col items-start gap-6 w-full">
            ...
            <div className="flex flex-col items-start gap-4 w-full">
              ...
              <div className="flex justify-between items-center w-full px-0 mb-4">
