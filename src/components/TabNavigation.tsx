...
export const TabNavigation: React.FC<TabNavigationProps> = ({
  ...
  return (
    <nav className="flex items-center w-full" role="tablist">
      <button
        role="tab"
        aria-selected={activeTab === 'faturamento'}
        onClick={() => onTabChange('faturamento')}
        className={`flex w-[180px] flex-col justify-center items-center gap-2.5 px-2.5 py-3 rounded-[50px_0px_0px_50px] max-sm:w-[calc(50%-0.5px)] ${
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className={`text-sm font-extrabold tracking-[0.01em] max-sm:text-xs ${
            activeTab === 'faturamento' 
      ...
      <button
        ...
        className={`flex w-[179px] flex-col justify-center items-center gap-2.5 px-2.5 py-3 rounded-[0px_50px_50px_0px] max-sm:w-[calc(50%-0.5px)] ${
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className={`text-sm font-medium tracking-[0.01em] max-sm:text-xs ${
            activeTab === 'fechamento' 
              ? 'bg-gradient-to-r from-[#78B60F] to-[#6D96E4] bg-clip-text text-transparent'
              : 'text-[#7A7B7D]'
          }`}>
